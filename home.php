         ...
         ?>
            ...
            <?php include('navbar.php');    ?>
                ...
                <div class="row  mx-3 gx-5 gy-3" style="height: 250px;">
                    ...
                    <div class="col-sm-12 col-xl-3 col-lg-6 col-md-6  op " >
                        <div class="p-5"  style="border-radius: 10px; background: #FEFBEC; "><div><i style="color: #00C1FE;" class="fas fa-3x fa-dollar-sign"></i></div> <p>payments</p>  <div class="text-end nb"><sub style="font-size:large;">DHs</sub> 556,000</div> </div>
                    </div>
                    <!--col4-->
